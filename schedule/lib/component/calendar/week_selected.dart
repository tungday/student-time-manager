...
class WeekSelected extends StatefulWidget {
  const WeekSelected({super.key, this.child});
...
class _WeekSelectedState extends State<WeekSelected> {
  ...
  Map<DateTime, List<ScheduleInfo>> _schedules = {};
          ...
          children: [
            ...
            Expanded(
              child: SingleChildScrollView(
                child: widget.child
                    // Neu child la ListView.builder thi nho them thuoc tinh sau:
                    // physics: NeverScrollableScrollPhysics(),
                    // de co the scroll duoc item
              ),
            )
          ],
        ));
